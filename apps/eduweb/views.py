...
# =============================================================================
# CONSULTATION BOOKING — moved to apps/consultation/views.py (slot + Paystack
# payment flow). ConsultationRequest above is kept only for historical rows
# from before that move; nothing writes to it any more.
# =============================================================================
