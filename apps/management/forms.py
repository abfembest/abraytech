...
class LMSCourseForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from apps.eduweb.models import Course as AcademicCourse
        self.fields['academic_course'].queryset = (
            ...
            .order_by('program__department__faculty__name', 'program__department__name', 'program__name', 'code')
        )
...
class LibraryItemForm(forms.ModelForm):
    ...
    class Meta:
        from apps.eduweb.models import LibraryItem as _LI
        model  = _LI
        fields = [
...
class AdminMessageComposeForm(forms.ModelForm):
    ...
    class Meta:
        from apps.eduweb.models import Message
        model = Message
